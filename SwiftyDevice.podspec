...
Pod::Spec.new do |s|
  s.name             = 'SwiftyDevice'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SwiftyDevice.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'legranddamien' => 'legrand.damien.06@gmail.com' }
  s.source           = { :git => 'https://github.com/legranddamien/SwiftyDevice.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'SwiftyDevice/Classes/**/*'
  
  # s.resource_bundles = {
  #   'SwiftyDevice' => ['SwiftyDevice/Assets/*.png']
  # }
